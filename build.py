...
DEFAULT_FLAGS = {'-Wall', '-pedantic','-std=c99', '-DSOKOL_GLCORE33', '-DPROJECT_VERSION=' + VERSION}
...
with Executable('Zany80') as Zany80:
    ...
    Zany80.add_dependencies('sokol')
    Zany80.add_includes('lib/sokol/')
