...
struct ti_interrupts {
	...
	struct {
		unsigned on_key : 1;
		unsigned first_timer : 1;
		unsigned second_timer : 1;
		unsigned on_key_pressed : 1;
		unsigned link_activity : 1;
		unsigned first_crystal : 1;
		unsigned second_crystal : 1;
		unsigned third_crystal : 1;
	} interrupted;
