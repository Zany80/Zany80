...
bool limn_cycle(limn_t *cpu) {
    ...
    switch (current_opcode) {
        ...
        // This implementation is almost certainly correct; something else isn't.
        // Deliberately triggering a Unknown Opcode error to avoid a later bus error,
        // since either way this interpreter needs to be revamped
       // case 0x33: {
         //   uint8_t R0 = pc_byte(cpu);
           // uint8_t R1 = pc_byte(cpu);
        //    uint32_t IMM = pc_long(cpu);
